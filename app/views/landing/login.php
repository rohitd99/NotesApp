        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header text-bg-dark d-flex justify-content-between">
                    <h1 class="fs-3 fw-bold">Login Form</h1>
                    <a href="/NotesApp/" class="home-link"><i class="fa-sharp fa-solid fa-circle-xmark fa-lg" style="color: #73538d"></i></a>
                </div>
                <div class="card-body">
                    <p class="error"><?php if (isset($errors['is_match'])) {
                                            echo $errors['is_match'];
                                        } ?></p>
                    <form action="" method="POST" id="form" novalidate>
                        ...
                        <div class="d-flex align-content-center my-3">
                            <input type="checkbox" name="remember" id="remember" <?php if (isset($data['remember'])) echo "checked='checked'"; ?> class="form-check-input form-check-inline" />
                            <label for="remember" class="form-check-label">Remember Me</label>
                        </div>
                        <div class="d-flex justify-content-center">
                            <button type="submit" class="btn btn-outline-success submit-btn mt-4 px-5">
                                Login
                            </button>
                        </div>
                    </form>
                ...
                <div class="card-footer">
                    <p class="px-3">
                        Don't have an account ? <a href="/NotesApp/signup">Signup</a>
                    </p>
                </div>
            </div>
        </div>
